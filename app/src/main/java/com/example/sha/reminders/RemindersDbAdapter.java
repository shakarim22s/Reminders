...
/**
 * Created by adhabiya on 10/03/2016.
 */
public class RemindersDbAdapter {
    ...
    //open public
    void dbOpen() throws SQLException {
    ...
    //CREATE //note that the id will be created for you automatically
    ...
    public long createReminder(Reminder reminder) {
        ...
        values.put(COL_IMPORTANT, reminder.getmImportant()); // Contact Phone Number
        // Inserting Row
